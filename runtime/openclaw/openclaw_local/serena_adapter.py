...
LEGACY_TOOL_ALIASES = {
    ...
    "context_search_ranked": "context.search_ranked",
    "context_file_digest": "context.file_digest",
    "context_symbol_index": "context.symbol_index",
    "context_dependency_map": "context.dependency_map",
    "context_related_paths": "context.related_paths",
    "context_bundle": "context.bundle",
    "context_change_impact": "context.change_impact",
    "context_todo_scan": "context.todo_scan",
    "memory_lookup": "memory.lookup",
    "memory_session_recap": "memory.session_recap",
    "memory_derived_index": "memory.derived_index",
    "memory_evidence_digest": "memory.evidence_digest",
    "governance_preflight": "governance.preflight",
    "governance_step_status": "governance.step_status",
    "governance_trace_gap_scan": "governance.trace_gap_scan",
    "governance_protected_path_check": "governance.protected_path_check",
    "artifacts_evaluate_serena": "artifacts.evaluate_serena",
    "artifacts_write_derived": "artifacts.write_derived",
    "artifacts_write_memory_derived": "artifacts.write_memory_derived",
    "canon_prepare_change": "canon.prepare_change",
    "canon_apply_controlled_change": "canon.apply_controlled_change",
    "canon_prepare_multi_change": "canon.prepare_multi_change",
    "canon_apply_multi_change": "canon.apply_multi_change",
