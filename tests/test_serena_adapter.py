            ...
            "tool_names": sorted(
                {
                    ...
                    "context_search_ranked",
                    "context_file_digest",
                    "context_symbol_index",
                    "context_dependency_map",
                    "context_related_paths",
                    "context_bundle",
                    "context_change_impact",
                    "context_todo_scan",
                    "memory_lookup",
                    "memory_session_recap",
                    "memory_derived_index",
                    "memory_evidence_digest",
                    "governance_preflight",
                    "governance_step_status",
                    "governance_trace_gap_scan",
                    "governance_protected_path_check",
                    "artifacts_evaluate_serena",
                    "artifacts_write_derived",
                    "artifacts_write_memory_derived",
                    "canon_prepare_change",
                    "canon_apply_controlled_change",
                    "canon_prepare_multi_change",
                    "canon_apply_multi_change",
