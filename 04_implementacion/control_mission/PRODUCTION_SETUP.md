...
If `OPENCLAW_GATEWAY_TOKEN` is omitted, Mission Control will try to read the token from `%USERPROFILE%\\.openclaw\\openclaw.json` (Windows) or `~/.openclaw/openclaw.json` (Unix-like systems).
...
```bash
# .env.local
OPENCLAW_GATEWAY_URL=https://your-machine.tail12345.ts.net
...
OPENCLAW_GATEWAY_URL=https://gateway.yourdomain.com
...
4. Test health endpoint: `curl http://127.0.0.1:18789/health`
...
| `OPENCLAW_GATEWAY_URL` | `http://openclaw-gateway:18789` | Gateway HTTP URL |
...
- [Agent Protocol Documentation](https://github.com/Dtcsrni/Sistema_Operativo_Tesis_Publico/blob/main/04_implementacion/control_mission/docs/AGENT_PROTOCOL.md)
- [Real-Time Implementation](https://github.com/Dtcsrni/Sistema_Operativo_Tesis_Publico/blob/main/04_implementacion/control_mission/REALTIME_IMPLEMENTATION_SUMMARY.md)
- [the orchestrator Orchestration Guide](https://github.com/Dtcsrni/Sistema_Operativo_Tesis_Publico/blob/main/04_implementacion/control_mission/src/lib/orchestration.ts)
- [Verification Checklist](https://github.com/Dtcsrni/Sistema_Operativo_Tesis_Publico/blob/main/04_implementacion/control_mission/VERIFICATION_CHECKLIST.md)
