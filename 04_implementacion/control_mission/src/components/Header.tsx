...
import { OpenClawApprovalsButton } from './OpenClawApprovalsButton';
      ...
      {portraitWorkspaceHeader ? (
        <>
          <div className="flex items-center justify-between gap-2 min-w-0">
            ...
            <OpenClawApprovalsButton />
            <Link href="/autopilot" className="min-h-11 min-w-11 p-2 hover:bg-mc-bg-tertiary rounded text-mc-text-secondary" title="Autopiloto">
              <Rocket className="w-5 h-5" />
            </Link>
            <button onClick={() => router.push('/settings')} className="min-h-11 min-w-11 p-2 hover:bg-mc-bg-tertiary rounded text-mc-text-secondary shrink-0" title="Ajustes">
          ...
          <div className="flex items-center gap-2 min-w-0">
            ...
            <div className="flex-1 grid grid-cols-2 gap-2">
              <div className="min-h-11 rounded border border-mc-border bg-mc-bg-tertiary px-2 flex items-center justify-center gap-1.5 text-xs">
                ...
                <span className="text-mc-text-secondary">activos</span>
              </div>
              <div className="min-h-11 rounded border border-mc-border bg-mc-bg-tertiary px-2 flex items-center justify-center gap-1.5 text-xs">
                <span className="text-mc-accent-purple font-semibold">{tasksInQueue}</span>
                <span className="text-mc-text-secondary">en cola</span>
              </div>
            </div>
          </div>
        </>
        ...
        <>
          <div className="flex items-center gap-2 md:gap-4 min-w-0">
            <div className="hidden sm:flex items-center gap-2">
              ...
              <span className="font-semibold text-mc-text uppercase tracking-wider text-sm">Control de Misión</span>
            </div>
            ...
            {workspace ? (
              ...
              <Link href="/" className="flex items-center gap-2 px-3 py-1 bg-mc-bg-tertiary rounded hover:bg-mc-bg transition-colors">
                <LayoutGrid className="w-4 h-4" />
                <span className="text-sm">Todos los Espacios</span>
              </Link>
            )}
          </div>
          ...
          {workspace && (
            <div className="hidden lg:flex items-center gap-8">
              <div className="text-center">
                ...
                <div className="text-xs text-mc-text-secondary uppercase">Agentes Activos</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-mc-accent-purple">{tasksInQueue}</div>
                <div className="text-xs text-mc-text-secondary uppercase">Tareas en Cola</div>
              </div>
            </div>
          )}
          ...
          <div className="flex items-center gap-2 md:gap-4">
            ...
            <button onClick={() => router.push('/settings')} className="min-h-11 min-w-11 p-2 hover:bg-mc-bg-tertiary rounded text-mc-text-secondary" title="Ajustes">
              <Settings className="w-5 h-5" />
            </button>
          </div>
        </>
