...
export function MentionInput({
  ...
  const specialTargets = [
    { id: '__all__', name: 'all', avatar_emoji: '📢', role: 'Difusión a todos los agentes', status: 'standby', is_assigned: false, is_convoy_member: false },
    { id: '__lead__', name: 'lead', avatar_emoji: '⭐', role: 'Líder / agente asignado', status: 'standby', is_assigned: false, is_convoy_member: false },
  ];
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-1.5">
                  ...
                  {agent.is_assigned && (
                    <span className="text-[9px] px-1 py-0.5 bg-mc-accent/20 text-mc-accent rounded">asignado</span>
                  )}
