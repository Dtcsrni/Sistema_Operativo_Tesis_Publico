...
import { getOpenClawGatewayToken, getOpenClawGatewayUrl } from '@/lib/openclaw/config';
...
function getGatewayUrl(): string {
  return getOpenClawGatewayUrl().replace('ws://', 'http://').replace('wss://', 'https://');
}

function getGatewayToken(): string {
  return getOpenClawGatewayToken();
}
