# DEC-0017: Arquitectura del Atzin Scientific Engine
...
| :--- | :--- |
| **ID** | DEC-0017 |
| **Título** | Arquitectura Distribuida y Gobernanza del Atzin Scientific Engine |
| **Fecha** | 2026-04-29 |
...
- **Trazabilidad**: Toda respuesta generada por Atzin debe incluir referencias al corpus de Weaviate con su respectivo hash de integridad.
