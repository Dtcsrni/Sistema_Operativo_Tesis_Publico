...
sys.path.insert(0, str(Path(__file__).resolve().parents[1] / "serena")) # serena siblings
...
try:
    from serena.check_serena_access import collect_report  # type: ignore  # noqa: E402
