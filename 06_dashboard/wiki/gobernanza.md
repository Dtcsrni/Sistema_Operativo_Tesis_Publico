...
- Página siguiente en la ruta base: [Arquitectura](../publico/wiki/arquitectura.md).
- Relacionada: [Sistema](../publico/wiki/sistema.md).
- Relacionada: [Arquitectura](../publico/wiki/arquitectura.md).
...
- Todo flujo crítico debe poder ejecutarse por vía manual explícita; la asistencia con IA es opcional y nunca requisito operativo.
...
- Toda contribución con asistencia de IA en código o automatización debe dejar evidencia de prueba ejecutada y del resultado obtenido.
