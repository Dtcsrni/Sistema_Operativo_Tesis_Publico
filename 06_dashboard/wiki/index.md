...
Actualmente, el **7.7%** de los artefactos nucleares de esta tesis han sido verificados y firmados por el tesista humano.
...
- [Agente y Casos de Uso](../publico/wiki/casos_uso.md)
- [Sistema](../publico/wiki/sistema.md)
- [Gobernanza](../publico/wiki/gobernanza.md)
- [Arquitectura](../publico/wiki/arquitectura.md)
...
- La superficie **canónica no pública** gobierna canon, backlog, decisiones, bitácora y auditoría completa.
- La superficie **pública** es un bundle editorialmente curado y reproducible para divulgación y evaluación externa.
