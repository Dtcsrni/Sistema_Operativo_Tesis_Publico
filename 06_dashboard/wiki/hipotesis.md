...
- Página anterior en la ruta base: [Planeación](../publico/wiki/planeacion.md).
- Página siguiente en la ruta base: [Bloques](../publico/wiki/bloques.md).
...
1. Esta página derivada: [`06_dashboard/wiki/hipotesis.md`](../publico/wiki/hipotesis.md).
...
|---|---|---|
|[`00_sistema_tesis/config/hipotesis.yaml`](../publico/NOTA_SEGURIDAD_Y_ACCESO.md)|archivo|sí|
|[`00_sistema_tesis/config/bloques.yaml`](../publico/NOTA_SEGURIDAD_Y_ACCESO.md)|archivo|sí|

### Artefactos derivados relacionados

- Markdown interno: [`06_dashboard/wiki/hipotesis.md`](../publico/wiki/hipotesis.md)
- HTML interno: [`06_dashboard/generado/wiki/hipotesis.html`](../publico/wiki_html/hipotesis.html)
