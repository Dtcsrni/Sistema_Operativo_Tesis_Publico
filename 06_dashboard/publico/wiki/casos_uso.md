...
- Página siguiente en la ruta base: [Sistema](sistema.md).
...
1. Esta página derivada: [`06_dashboard/wiki/casos_uso.md`](casos_uso.md).
...
- Markdown interno: [`06_dashboard/wiki/casos_uso.md`](casos_uso.md)
- HTML interno: [`06_dashboard/generado/wiki/casos_uso.html`](https://github.com/Dtcsrni/Sistema_Operativo_Tesis_Publico/blob/main/06_dashboard/wiki_html/casos_uso.html)
- Markdown público sanitizado: [`06_dashboard/publico/wiki/casos_uso.md`](casos_uso.md)
- HTML público sanitizado: [`06_dashboard/publico/wiki_html/casos_uso.html`](https://github.com/Dtcsrni/Sistema_Operativo_Tesis_Publico/blob/main/06_dashboard/wiki_html/casos_uso.html)
