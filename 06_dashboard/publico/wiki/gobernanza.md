...
1. Esta página derivada: `06_dashboard/wiki/gobernanza.md`.
...
- Markdown interno: `06_dashboard/wiki/gobernanza.md`
- HTML interno: `06_dashboard/generado/wiki/gobernanza.html`
- Markdown público sanitizado: `06_dashboard/publico/wiki/gobernanza.md`
- HTML público sanitizado: `06_dashboard/publico/wiki_html/gobernanza.html`
