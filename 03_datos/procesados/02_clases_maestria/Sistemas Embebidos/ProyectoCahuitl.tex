...
El proyecto "Cahuitl" es una prueba de concepto que permitirá la implementación de un sistema de automatización de rutas y gestión digital de pagos para el transporte público. El desarrollo implementa el stack de internet de las cosas sobre hardware embebido, utilizando medios inalámbricos y nodos de sensores inteligentes que se comunican con una plataforma centralizada de control y monitoreo. El proyecto permitirá establecer las bases tecnológicas necesarias para la implementación de un prototipo funcional que permita mejorar el sistema público de transporte de cara a lograr una ciudad más sostenible 
...
\bibliography{bib/IEEEabrv,bib/UNSDG.bib} 
%%%%%%% Bibliografía %%%%%%%%    
