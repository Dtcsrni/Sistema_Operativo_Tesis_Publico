...
- **Libro Mayor (Ledger):** Registra cada instrucción humana crítica en [`log_conversaciones_ia.md`]([ledger_privado]).
...
- **Matriz de Trazabilidad:** Mantén actualizada la [`matriz_trazabilidad.md`]([matriz_privada]).
