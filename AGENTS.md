...
- **Libro Mayor (Ledger):** Registra cada instrucción humana crítica en [`log_conversaciones_ia.md`](https://github.com/Dtcsrni/Sistema_Operativo_Tesis_Publico/blob/main/00_sistema_tesis/bitacora/log_conversaciones_ia.md).
