...
async function createReporters(config, mode, isTestServer, descriptions) {
  ...
  for (const r of descriptions) {
    ...
    if (name in defaultReporters) {
      reporters.push(new defaultReporters[name](https://github.com/Dtcsrni/Sistema_Operativo_Tesis_Publico/blob/main/node_modules/playwright/lib/runner/options));
    } else {
