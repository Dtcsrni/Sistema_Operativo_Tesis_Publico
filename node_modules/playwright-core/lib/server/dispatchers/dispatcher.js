...
class Dispatcher extends _events.EventEmitter {
  ...
  async _handleCommand(callMetadata, method, validParams) {
    const commandPromise = this[method](https://github.com/Dtcsrni/Sistema_Operativo_Tesis_Publico/blob/main/node_modules/playwright-core/lib/server/dispatchers/validParams,);
    try {
