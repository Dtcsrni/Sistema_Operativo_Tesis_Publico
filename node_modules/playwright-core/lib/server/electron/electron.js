...
class Electron extends _instrumentation.SdkObject {
  ...
  async launch(options) {
    ...
    return controller.run(async progress => {
      ...
      const nodeMatchPromise = waitForLine(progress, launchedProcess, /^Debugger listening on (w ruta local no pública )$/);
      const chromeMatchPromise = waitForLine(progress, launchedProcess, /^DevTools listening on (w ruta local no pública )$/);
