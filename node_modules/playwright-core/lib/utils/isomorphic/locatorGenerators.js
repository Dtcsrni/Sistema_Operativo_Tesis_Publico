...
function asLocators(lang, selector, isFrameLocator = false, maxOutputSize = 20, preferredQuote) {
  try {
    return innerAsLocators(new generators[lang](https://github.com/Dtcsrni/Sistema_Operativo_Tesis_Publico/blob/main/node_modules/playwright-core/lib/utils/isomorphic/preferredQuote), (0, _selectorParser.parseSelector)(selector), isFrameLocator, maxOutputSize);
  } catch (e) {
